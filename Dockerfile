...
FROM --platform linux/arm64 --provenance=false public.ecr.aws/lambda/nodejs:22 AS builder
...
FROM --platform linux/arm64 --provenance=false public.ecr.aws/lambda/nodejs:22
